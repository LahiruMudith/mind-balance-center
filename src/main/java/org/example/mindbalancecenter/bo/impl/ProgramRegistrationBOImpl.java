...
public class ProgramRegistrationBOImpl implements ProgramRegistrationBO {
    ...
    public PatientDto searchPatientById(String id) throws Exception {
        ...
        int  patientYear = patient.getYearOfBirth().getValue();
    ...
    public boolean register(ProgramRegistrationDto programRegistrationDto) throws Exception {
        ...
        try {
            ...
            programRegistration.setProgramId(therapyProgramDAO.search(programRegistrationDto.getProgramId()));
            programRegistration.setPatientId(patientDAO.search(programRegistrationDto.getPatientId()));
